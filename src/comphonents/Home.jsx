...
const Home = () => {
  ...
  const [typeEffect] = useTypewriter({
    words: ['WEB DEVELOPER', 'FRONT-END DEVELOPER', 'BACK-END DEVELOPER', 'FULL-STACK DEVELOPER', 'MERN-STACT DEVELOPER'],
    loop:{},
    typeSpeed:100,
    deleteSpeed:40
  })      
    ...
    <div className=' w-full '>
      <div className=' md:flex md:flex-row flex flex-col items-center md:justify-center mx-auto p-2 md:gap-16 gap-3'>
        <div className='md:w-[60%] wow animate__animated animate__backInLeft'>
          ...
          <p className='md:text-5xl text-2xl font-semibold'>I am a <span className='italic text-orange-400 md:text-4xl font-bold text-xl'>{typeEffect}</span></p>
